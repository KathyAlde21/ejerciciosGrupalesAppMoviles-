package Modulo_2.ejercicioGrupal11;
...
public class Ejemplo102 {
    public static void main(String[] args) {
        ...
        String mensaje = "Lorem ipsum dolor sit amet, consectetur adipiscing elit."
                ...
                + " consequat. Maecenas quis lorem sit amet diam consequat"
                ...
                + " curae; Suspendisse pretium, quam non consectetur scelerisque,"
                + " diam tortor iaculis arcu, nec tincidunt diam eros sed urna."
                + " Ut at consequat enim. Orci varius natoque penatibus et magnis"
                + " dis parturient montes, nascetur ridiculus mus. Donec sit"
